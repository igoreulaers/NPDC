...
# Simple format -----------------------------------------------------------
MOSJ <- fieldLab_df[fieldLab_df$dynamicProperties.projectName == "egg" & fieldLab_df$scientificName == "Larus hyperboreus",]
...
write.xlsx(MOSJ_long_simple, file = "MOSJ - glaucous gull - simple.xlsx")
...
write.xlsx(MOSJ_long_extF, file = "MOSJ - glaucous gull - extended field.xlsx")
...
write.xlsx(MOSJ_long_extL, file = "MOSJ - glaucous gull - extended lab.xlsx")
...
write.xlsx(MOSJ_long_extFL, file = "Glaucous gull_egg - extended field and lab.xlsx")
