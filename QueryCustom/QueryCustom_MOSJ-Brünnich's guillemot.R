...
# Simple format -----------------------------------------------------------
MOSJ <- fieldLab_df[fieldLab_df$dynamicProperties.projectName == "MOSJ" & fieldLab_df$scientificName == "Uria lomvia",]
...
write.xlsx(MOSJ_long_simple, file = "MOSJ - Brûnnichs's guillemot - simple.xlsx")
...
write.xlsx(MOSJ_long_extF, file = "MOSJ - Brûnnichs's guillemot - extended field.xlsx")
...
write.xlsx(MOSJ_long_extL, file = "MOSJ - Brûnnichs's guillemot - extended lab.xlsx")
...
write.xlsx(MOSJ_long_extFL, file = "MOSJ - Brûnnichs's guillemot - extended field and lab.xlsx")
