...
# Simple format -----------------------------------------------------------
QUERY <- fieldLab_df[fieldLab_df$scientificName == "Pagophila eburnea",]
...
write.xlsx(QUERY_long_simple, file = "Ivory gull - All data - simple.xlsx")
...
write.xlsx(QUERY_long_extF, file = "Ivory gull - All data - extended field.xlsx")
...
write.xlsx(QUERY_long_extL, file = "Ivory gull - All data - extended lab.xlsx")
...
write.xlsx(QUERY_long_extFL, file = "Ivory gull - All data - extended field and lab.xlsx")
